...
<head>
    ...
    <link rel="stylesheet" href="http://cdn.jsdelivr.net/gh/chapelr/serious/cdn/serious.min.css">
...
<script src="http://cdn.jsdelivr.net/gh/chapelr/serious/cdn/serious.min.js"></script>
